 ...
 * @author Alicinha
 */
public class CadastroAutorGenero extends javax.swing.JFrame {

    /**
     * Creates new form Autor
     */
    public CadastroAutorGenero()
    {
        initComponents();
    }
    ...
    private void initComponents()
    {
        ...
        jLabel1.setText("Adicionar Autor(es) / Gênero(s)");
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(CadastroAutorGenero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run()
            {
                new CadastroAutorGenero().setVisible(true);
            }
        });
    }
